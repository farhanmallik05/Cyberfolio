...
export default function Error({
  ...
  return (
    <div className="min-h-[70vh] pt-32 pb-16 px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
      ...
      <h2 className="text-2xl font-orbitron font-bold text-red-400 uppercase tracking-wider mb-2">Log Retrieval Failed</h2>
      <p className="text-zinc-400 mb-8 max-w-md">
        Failed to access the blog databanks. The connection to the mainframe may be unstable.
      </p>
